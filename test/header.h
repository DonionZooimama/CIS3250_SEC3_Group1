...
int driver(Error* err, int* test_number, int checkBoard,char playerInput, int numberOfPlay, int height, int width, char whichPlayer, int savePlace, int restorePlace, 
